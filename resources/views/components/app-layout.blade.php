...
<nav class="w-[300px] bg-white h-full hidden lg:flex flex-col gap-10 py-6 border-r">
    ...
    <ul class="w-full flex flex-col gap-6">
        ...
        <li>
            <a href="/beneficiary"
               class=" text-[18px] py-2 font-medium hover:text-primary-3 transition-all border-l-[6px] border-transparent duration-300 flex items-center {{(Request::is('beneficiary') | Request::is('beneficiary/*')) ? "text-primary-3  border-primary-3" : "text-[#b1b1b1]"}}">
                <svg width="25" height="25" viewBox="0 0 25 25" class="mr-5 ml-8" fill="currentColor"
                     xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_63796_130)">
                        <path
                            d="M0.5 20V17.225C0.5 16.6583 0.641667 16.1333 0.925 15.65C1.20833 15.1667 1.6 14.8 2.1 14.55C2.33333 14.4333 2.55833 14.325 2.775 14.225C3.00833 14.125 3.25 14.0333 3.5 13.95V20H0.5ZM4.5 13C3.66667 13 2.95833 12.7083 2.375 12.125C1.79167 11.5417 1.5 10.8333 1.5 10C1.5 9.16667 1.79167 8.45833 2.375 7.875C2.95833 7.29167 3.66667 7 4.5 7C5.33333 7 6.04167 7.29167 6.625 7.875C7.20833 8.45833 7.5 9.16667 7.5 10C7.5 10.8333 7.20833 11.5417 6.625 12.125C6.04167 12.7083 5.33333 13 4.5 13ZM4.5 11C4.78333 11 5.01667 10.9083 5.2 10.725C5.4 10.525 5.5 10.2833 5.5 10C5.5 9.71667 5.4 9.48333 5.2 9.3C5.01667 9.1 4.78333 9 4.5 9C4.21667 9 3.975 9.1 3.775 9.3C3.59167 9.48333 3.5 9.71667 3.5 10C3.5 10.2833 3.59167 10.525 3.775 10.725C3.975 10.9083 4.21667 11 4.5 11ZM4.5 20V17.2C4.5 16.6333 4.64167 16.1167 4.925 15.65C5.225 15.1667 5.61667 14.8 6.1 14.55C7.13333 14.0333 8.18333 13.65 9.25 13.4C10.3167 13.1333 11.4 13 12.5 13C13.6 13 14.6833 13.1333 15.75 13.4C16.8167 13.65 17.8667 14.0333 18.9 14.55C19.3833 14.8 19.7667 15.1667 20.05 15.65C20.35 16.1167 20.5 16.6333 20.5 17.2V20H4.5ZM6.5 18H18.5V17.2C18.5 17.0167 18.45 16.85 18.35 16.7C18.2667 16.55 18.15 16.4333 18 16.35C17.1 15.9 16.1917 15.5667 15.275 15.35C14.3583 15.1167 13.4333 15 12.5 15C11.5667 15 10.6417 15.1167 9.725 15.35C8.80833 15.5667 7.9 15.9 7 16.35C6.85 16.4333 6.725 16.55 6.625 16.7C6.54167 16.85 6.5 17.0167 6.5 17.2V18ZM12.5 12C11.4 12 10.4583 11.6083 9.675 10.825C8.89167 10.0417 8.5 9.1 8.5 8C8.5 6.9 8.89167 5.95833 9.675 5.175C10.4583 4.39167 11.4 4 12.5 4C13.6 4 14.5417 4.39167 15.325 5.175C16.1083 5.95833 16.5 6.9 16.5 8C16.5 9.1 16.1083 10.0417 15.325 10.825C14.5417 11.6083 13.6 12 12.5 12ZM12.5 10C13.05 10 13.5167 9.80833 13.9 9.425C14.3 9.025 14.5 8.55 14.5 8C14.5 7.45 14.3 6.98333 13.9 6.6C13.5167 6.2 13.05 6 12.5 6C11.95 6 11.475 6.2 11.075 6.6C10.6917 6.98333 10.5 7.45 10.5 8C10.5 8.55 10.6917 9.025 11.075 9.425C11.475 9.80833 11.95 10 12.5 10ZM20.5 13C19.6667 13 18.9583 12.7083 18.375 12.125C17.7917 11.5417 17.5 10.8333 17.5 10C17.5 9.16667 17.7917 8.45833 18.375 7.875C18.9583 7.29167 19.6667 7 20.5 7C21.3333 7 22.0417 7.29167 22.625 7.875C23.2083 8.45833 23.5 9.16667 23.5 10C23.5 10.8333 23.2083 11.5417 22.625 12.125C22.0417 12.7083 21.3333 13 20.5 13ZM20.5 11C20.7833 11 21.0167 10.9083 21.2 10.725C21.4 10.525 21.5 10.2833 21.5 10C21.5 9.71667 21.4 9.48333 21.2 9.3C21.0167 9.1 20.7833 9 20.5 9C20.2167 9 19.975 9.1 19.775 9.3C19.5917 9.48333 19.5 9.71667 19.5 10C19.5 10.2833 19.5917 10.525 19.775 10.725C19.975 10.9083 20.2167 11 20.5 11ZM21.5 20V13.95C21.75 14.0333 21.9833 14.125 22.2 14.225C22.4333 14.325 22.6667 14.4333 22.9 14.55C23.4 14.8 23.7917 15.1667 24.075 15.65C24.3583 16.1333 24.5 16.6583 24.5 17.225V20H21.5Z"
                            fill="#73777A"/>
                    </g>
                    <defs>
                        <clipPath id="clip0_63796_130">
    ...
    <div class="bg-white py-4 px-4 flex items-center justify-between">
            ...
            <a href="{{url()->previous()}}" class="{{(Request::is('/') ) ? "hidden" :"" }} hidden lg:block">
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M11.7283 1.66424C11.9138 1.86886 11.8982 2.18506 11.6936 2.3705L5.68377 7.81691C5.45953 8.02012 5.46581 8.37439 5.6971 8.56955L11.6803 13.6179C11.8913 13.7959 11.9181 14.1114 11.74 14.3224C11.5619 14.5335 11.2465 14.5602 11.0354 14.3821L5.05223 9.33384C4.35835 8.74838 4.33954 7.68557 5.01225 7.07592L11.0221 1.62951C11.2267 1.44408 11.5429 1.45963 11.7283 1.66424Z"
                          fill="#333333"/>
                </svg>
            </a>
        ...
        <div class="flex items-center  gap-10">
            <a href="/beneficiary/new-beneficiary"
               class="w-[60px] h-[60px] rounded-full bg-[#F5F7FA] {{Request::is('beneficiary') ? 'lg:flex' : 'hidden' }} hidden flex items-center justify-center font-semibold text-[#718EBF] text-4xl">
