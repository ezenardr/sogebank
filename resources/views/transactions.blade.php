        ...
        <div class="col-span-2">
            <div class="flex flex-col gap-3">
                ...
                <div class="flex overflow-x-auto lg:grid grid-cols-2 gap-10">
                    {{-- card 1 --}}
                    <div
                        class="min-w-full h-[213px] flex flex-col bg-gradient-to-r from-[#4C49ED] to-[#0A06F4] rounded-[20px] justify-between">
                        <div class="flex flex-col gap-3 p-4 lg:p-[25px]">
                            ...
                            <div class="flex space-x-14">
                                <div>
                                    <span
                                        class="text-white text-[10px] tracking-wider font-normal flex flex-col justify-between">CARD
                                        HOLDER</span>
                                    <span class="text-white text-[13px] tracking-wide font-semibold">Eddy Cusuma</span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] tracking-wider text-white flex flex-col font-normal justify-between">VALID
                                        THRU</span>
                    ...
                    {{-- card 2 --}}
                    <div
                        class="min-w-full h-[213px] flex flex-col bg-white border border-[#DFEAF2] rounded-[20px] justify-between">
                        <div class="flex flex-col gap-3 p-4 lg:p-[25px]">
                            <div class="flex justify-between">
                                <div class="flex flex-col">
                                    <span
                            ...
                            <div class="flex space-x-14">
                                <div>
                                    <span
                                        class="text-[10px] tracking-wider text-[#718EBF] flex flex-col justify-between">CARD
                                        HOLDER</span>
                                    <span class="text-primary-2 text-[13px] tracking-wide font-semibold">Eddy
                                        Cusuma</span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] tracking-wider text-[#718EBF] flex flex-col justify-between">VALID
                                        THRU</span>
