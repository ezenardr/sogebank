<x-app-layout >
        ...
        <div class="col-span-2">
            <div class="flex flex-col gap-3">
                ...
                <div class="flex overflow-x-auto lg:grid grid-cols-2 gap-10">
                    {{-- card 1 --}}
                    <div class=" min-w-full flex flex-col  bg-gradient-to-r from-[#4C49ED] to-[#0A06F4] rounded-[20px] justify-between">
                        ...
                        <div class=" w-full h-1/3 rounded-b-[20px] border-t border-transparent" style="background: linear-gradient(180deg, rgba(255, 255, 255, 0.15) 0%, rgba(255, 255, 255, 0) 100%)">
                            <div class="flex justify-between px-4 lg:px-[25px] py-[20px]">
                                ...
                                <div class="justify-center items-center">
                                    <svg width="40.5" height="28.5" viewBox="0 0 27 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="9.20455" cy="9.20455" r="9.20455" fill="#ffffff" fill-opacity="0.5"/>
                                        <circle cx="17.7955" cy="9.20455" r="9.20455" fill="#ffffff" fill-opacity="0.5"/>
                                    </svg>    
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- card 2 --}}
                    <div class="min-w-full flex flex-col  bg-white border border-[#DFEAF2] rounded-[20px] justify-between">
                        <div class="flex flex-col gap-3 p-4 lg:p-[25px]">
                            <div class="flex justify-between">
                                <div class="flex flex-col">
                                    <span
                            ...
                            <div class="flex space-x-14">
                                <div>
                                    ...
                                    <span class="text-primary-2 text-[13px] tracking-wide font-semibold">Eddy Cusuma</span>
                                </div>
                                <div>
                                    <span
                        ...
                        <div class=" w-full h-1/3 border-t border-[#DFEAF2] rounded-b-[20px]">
                            <div class="flex justify-between px-4 lg:px-[25px] py-[20px]">
                                <span class="text-primary-2 text-[15px] tracking-wide font-normal">3778********1234</span>
                                <div class="justify-center items-center">
                                    <svg width="40.5" height="28.5" viewBox="0 0 27 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="9.20455" cy="9.20455" r="9.20455" fill="#9199AF" fill-opacity="0.5"/>
                                        <circle cx="17.7955" cy="9.20455" r="9.20455" fill="#9199AF" fill-opacity="0.5"/>
                                    </svg>    
                                </div>
                            </div>
                        </div>
    ...
    <div class="pt-4">
        ...
        <div class="">
            ...
            {{-- partie tab recent --}}
            <div class="rounded-[25px] py-2 bg-white mt-8">
    ...
    <div class="mt-4 h-32 w-full flex">
        <nav class="mx-auto lg: mr-0">
            <ul class="w-full flex items-center justify-between lg:justify-normal">
                ...
                <li class="">
                    <a href="/transactions" class=" text-[15px] justify-center font-medium w-[40px] h-[40px] rounded-[10px] bg-transparent text-primary-3 hover:bg-primary-3 hover:text-white transition-all duration-100 flex items-center {{Request::is('Transactions') ? "text-white  bg-primary-3" : "text-primary-3 bg-transparent"}}">
                        <div>
                            <span class="">1</span>
                        </div>
                    </a>    
